...
import { Breadcrumb, BreadcrumbItem, Button, Form, FormGroup, FormFeedback, Label, Col, Input } from 'reactstrap';
                    ...
                    <div className="col-12 col-md-9">
                        <Form onSubmit={this.handleSubmit}>
                            ...
                            <FormGroup row>
                                ...
                                <Col md={10}>
                                    <Input type="textarea" id="message" name="message" rows="12" value={this.state.message} onChange={this.state.message} >
                                    </Input>
                                </Col>
                            </FormGroup>
                            <FormGroup row>
